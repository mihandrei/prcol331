...
public class EditMaterialeActivity extends AbstractActivity{
	...
	public void start(final AcceptsOneWidget panel, EventBus eventBus) {
		if (view == null) {
			view = new EditMaterialeView(GWT.getModuleBaseURL()+"upload","upl");
		...
		view.clear();
		rpc.getMateriale(place.getMaterieid(),new AppAsyncCallback<List<Resource>>() {
			@Override
	...
	public void onAdd() {
		view.addRow(view.resName.getText(), view.upl.getFilename());
	}
}
